...
- 깊이 스케일 통일 (min_depth, max_depth, pass_max_depth_diff 모두 동일한 스케일 사용)
"""
...
class VisualizationSystem:
    ...
    def _setup_windows(self):
        ...
        # 부표 사이 통과 미션 파라미터 트랙바 (스케일 통일: 직접 미터 단위)
    ...
    def update_parameters_from_trackbars(self) -> Dict:
        ...
        # 부표 사이 통과 미션 파라미터 (스케일 통일: 직접 미터 단위)
